...
public class ReactVlcPlayerView extends TextureView implements
    ...
    private IVLCVout.OnNewVideoLayoutListener onNewVideoLayoutListener = new IVLCVout.OnNewVideoLayoutListener() {
        ...
        public void onNewVideoLayout(IVLCVout vout, int width, int height, int visibleWidth, int visibleHeight, int sarNum, int sarDen) {
            ...
            VLCPlayerLayoutEvent event = new VLCPlayerLayoutEvent(getId(),
                    Double.longBitsToDouble(mVideoWidth),
                    Double.longBitsToDouble(mVideoHeight),
                    Double.longBitsToDouble(mVideoVisibleWidth),
                    Double.longBitsToDouble(mVideoVisibleHeight),
                    Double.longBitsToDouble(mSarNum),
                    Double.longBitsToDouble(mSarDen)
            );
            if (listener != null) {
                listener.onLayoutChange(event);
            }
        }
    };
    ...
    private void createPlayer() {
        ...
        try {
            ...
            boolean isNetwork =
                    !uriString.matches("/^(assets-library|file|content|ms-appx|ms-appdata):/");
...
//                    break;
    ...
    public interface EventListener{
        void onEventUpdate(boolean playing, double position, double currentTime, double duration, double bufferRate, String type);
        void onLayoutChange(VLCPlayerLayoutEvent event);
    }
